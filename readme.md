...
Run `python -m mcdreforged pack` in console, tt will pack your sources into a packed plugin `ExamplePlugin-v1.1.0.mcdr`

Put `ExamplePlugin-v1.1.0.mcdr` into the plugin folder of MCDR to use it
